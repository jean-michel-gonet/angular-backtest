...
describe('YahooWriter', () => {
  ...
  it('Can convert historical quotes into Yahoo CSV file', () => {
    ...
    expect(csv1).toBe("Date,Open,High,Low,Close,Adj Close,Volume\r\n" +
	     "2001-12-25,100.000000,110.000000,80.000000,90.000000,89.000000,100000\r\n" +
	     "2001-12-26,105.000000,115.000000,85.000000,95.000000,94.000000,150000\r\n");

    let csv2: string = yahooWriter2.asYahooCsvFile();
    expect(csv2).toBe("Date,Open,High,Low,Close,Adj Close,Volume\r\n" +
	     "2001-12-25,10.000000,11.000000,8.000000,9.000000,8.900000,600\r\n" +
	     "2001-12-26,20.000000,21.000000,18.000000,19.000000,18.000000,300\r\n");
  });
  ...
  it('Can convert historical quotes with missing data into Yahoo CSV file', () => {
    ...
    expect(csv1).toBe("Date,Open,High,Low,Close,Adj Close,Volume\r\n" +
       "2001-12-25,90.000000,90.000000,90.000000,90.000000,90.000000,0\r\n" +
       "2001-12-26,95.000000,95.000000,95.000000,95.000000,95.000000,0\r\n");
  });
});
